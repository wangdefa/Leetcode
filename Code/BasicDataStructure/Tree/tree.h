...
class Tree 
{
    ...
    public:
        Tree(uint32_t sz)
        {
            ...
            for (uint32_t index = 0; index < sz; index++)
            {
                ...
                if (rand() % 10 >= 2)
                {
                    ...
                    // std::cout << val << " act as left child, parent is:" << node->val << std::endl;
                }
                ...
                if (rand() % 10 >= 1)
                {
                    ...
                    // std::cout << val << " act as right child, parent is:" << node->val << std::endl;
                }
            }
        }
        ...
        void Traverse(TraverseMode mode)
        {
            switch(mode)
            {
                case TraverseMode::FIRST: TraverseFirst(head); break;
                case TraverseMode::MIDDLE: TraverseMiddle(head); break;
                case TraverseMode::LAST: TraverseLast(head); break;
